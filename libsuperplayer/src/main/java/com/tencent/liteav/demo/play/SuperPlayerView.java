...
public class SuperPlayerView extends RelativeLayout implements ITXVodPlayListener, ITXLivePlayListener, TCVodControllerLarge.OnVideoShrinkListener {
    ...
    private boolean isShowIvFullScreen = true;
    ...
    public void setShowIvFullScreen(boolean showIvFullScreen) {
        isShowIvFullScreen = showIvFullScreen;
    }
    ...
    private void initView(Context context) {
        ...
        mVodControllerLarge.setOnVideoShrinkListener(this);
    }
...
//        popupWindow.setFocusable(true);
    ...
    public void onPlayEvent(TXVodPlayer player, int event, Bundle param) {
        ...
        if (event == TXLiveConstants.PLAY_EVT_VOD_PLAY_PREPARED) { //视频播放开始
            ...
            if (onVideoListener != null) {
                onVideoListener.onVideoPlayStart(mVodPlayer.getDuration());
            }
            ...
            if (onVideoListener != null) {
                onVideoListener.onVidoePlayEnd();
            }
...
//                && event != TXLiveConstants.PLAY_ERR_VOD_UNSUPPORT_DRM
    ...
    public void onPlayEvent(int event, Bundle param) {
        ...
        if (event == TXLiveConstants.PLAY_EVT_VOD_PLAY_PREPARED) { //视频播放开始
            ...
            mVodControllerLarge.updateReplay(false);
            if (onVideoListener != null) {
                onVideoListener.onVideoPlayStart(0);
            }
        } else if (event == TXLiveConstants.PLAY_EVT_PLAY_BEGIN) {
            mVodControllerSmall.updateLiveLoadingState(false);
            mVodControllerLarge.updateLiveLoadingState(false);
...
//        }
    ...
    public interface onVideoListener {
        ...
        void onVideoPlayStart(float duration);
    ...
    public void setOnVideoListener(SuperPlayerView.onVideoListener onVideoBackListener) {
        this.onVideoListener = onVideoBackListener;
    }

    @Override
    public void onVideoShrinkClick() {
        if (onVideoListener != null) {
            onVideoListener.onVideoShrink();
            mVodController.onRequestPlayMode(SuperPlayerConst.PLAYMODE_WINDOW);
        }
    }
    ...
    public void replayPlay(){
        mVodControllerSmall.replayPlay();
    }
     ...
     */
    public void onHide(){
        mVodControllerSmall.mLockScreen = true;
        mVodControllerLarge.mLockScreen = true;
    }
