...
//        mTvQuality.setOnClickListener(this);
        mIvQuality.setOnClickListener(this);
...
//            mVodController.onBackPress(SuperPlayerConst.PLAYMODE_FULLSCREEN);
            if (onVideoShrinkListener != null){
                onVideoShrinkListener.onVideoShrinkClick();
            }
...
//        }
    ...
    //跳转评论的接口
    public interface OnVideoShrinkListener {
        void onVideoShrinkClick();
    }

    private OnVideoShrinkListener onVideoShrinkListener;

    public void setOnVideoShrinkListener(OnVideoShrinkListener onVideoShrinkListener) {
        this.onVideoShrinkListener = onVideoShrinkListener;
    }
}
