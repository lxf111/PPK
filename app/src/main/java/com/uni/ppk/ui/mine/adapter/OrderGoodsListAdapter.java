...
import com.uni.ppk.ui.mine.bean.GoodsListBean;
...
//        ImageUtils.getCircularPic(mBean.get(position).getGoods_img(), mHolder.ivImg, mContext, 10, R.mipmap.ic_default_wide);
