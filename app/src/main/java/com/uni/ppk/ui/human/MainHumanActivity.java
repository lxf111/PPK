 ...
 * 人力市场首页
 */
public class MainHumanActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_main_human;
    }
...
//                        finish();
                        ...
                        if (NetUtils.hasNetwork(MainHumanActivity.this)) {
                            //连接不到聊天服务器
