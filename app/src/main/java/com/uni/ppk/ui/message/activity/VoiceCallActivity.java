...
import com.hyphenate.PhoneStateManager;
...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
    ...
    private LinearLayout llytImgBg;//显示的背景

    private LinearLayout llytMute;//静音
    private LinearLayout llytHandsfree;//免提
    ...
    private boolean isCollection = false;//是否接通过
    private boolean isMine = false;//是否是我发的单子
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivNarrow = (ImageView) findViewById(R.id.iv_narrow);

        llytHeader = findViewById(R.id.llyt_header);
        ivOtherHeader = findViewById(R.id.iv_other_header);
        ivMyHeader = findViewById(R.id.iv_my_header);
        tvMyName = findViewById(R.id.tv_my_name);

        llytImgBg = findViewById(R.id.llyt_img_bg);

        llytMute = findViewById(R.id.llyt_mute);
        llytHandsfree = findViewById(R.id.llyt_handsfree);

        llCall = findViewById(R.id.ll_call);
        ivCancel = findViewById(R.id.iv_cancel);
        ivExchange = findViewById(R.id.iv_exchange);
...
//                EMLog.d("EMCallManager", "onCallStateChanged:" + callState);
                ...
                switch (callState) {
                    ...
                    case ACCEPTED:
                        ...
                        if (callExt != null && !"".equals(callExt)) {
                            try {
                                JSONObject object = new JSONObject(callExt);
                                if (object.has("orderId") && !object.isNull("orderId")) {
                                    mOrderId = object.getString("orderId");
                                }
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                llytMute.setVisibility(View.VISIBLE);
                                llytImgBg.setVisibility(View.GONE);
                                llytHandsfree.setVisibility(View.VISIBLE);
                                llytHeader.setVisibility(View.VISIBLE);
...
//            hangupBtn.setVisibility(View.VISIBLE);
        ...
        } else if (i == R.id.btn_hangup_call || i == R.id.iv_cancel) {
