...
public class CustomRatingBar extends LinearLayout {
    ...
    public CustomRatingBar(Context context, AttributeSet attrs) {
        ...
        starPadding = mTypedArray.getDimension(R.styleable.CustomRatingBar_starPadding, 10);
        starStep = mTypedArray.getFloat(R.styleable.CustomRatingBar_starStep, 1.0f);
