...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        myUserHead = fragmentArgs.getString("myHeader");
        myName = fragmentArgs.getString("myName");
...
//        }
        inputMenu.registerExtendMenuItem("拍照", R.drawable.ic_message_camera, ITEM_TAKE_PICTURE,
                extendMenuItemClickListener);
        inputMenu.registerExtendMenuItem("照片", R.drawable.ic_message_photo, 2, extendMenuItemClickListener);
//        inputMenu.registerExtendMenuItem("照片", R.drawable.icon_zp, 2, extendMenuItemClickListener);
//        inputMenu.registerExtendMenuItem("拍照", R.drawable.icon_zp, ITEM_TAKE_PICTURE, extendMenuItemClickListener);
    }
...
//            EMLog.e(TAG, "----------------------------------"+toChatUsername);
    ...
    protected void sendMessage(EMMessage message) {
        ...
        message.setAttribute(EaseConstant.EXTRA_USER_MY_NAME, myName);
