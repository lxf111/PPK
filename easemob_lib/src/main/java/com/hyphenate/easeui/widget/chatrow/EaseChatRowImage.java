...
public class EaseChatRowImage extends EaseChatRowFile {
    ...
    public static ShowBigImageListener showBigImageListener;

    public static void setShowBigImageListener(ShowBigImageListener l) {
        showBigImageListener = l;
    }

    public interface ShowBigImageListener {
        void showBigImage(String[] imgUrls, String currentImg);
    }
