...
import com.hyphenate.easeui.widget.chatrow.EaseChatRowTextGoods;
...
public class EaseChatTextGoodsPresenter extends EaseChatRowPresenter {
    private static final String TAG = "EaseChatTextGoodsPresenter";

    @Override
    protected EaseChatRow onCreateChatRow(Context cxt, EMMessage message, int position, BaseAdapter adapter) {
        return new EaseChatRowTextGoods(cxt, message, position, adapter);
    }
