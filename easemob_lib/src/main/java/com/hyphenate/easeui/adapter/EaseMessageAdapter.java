...
import com.hyphenate.easeui.widget.presenter.EaseChatTextGoodsPresenter;
...
//                            "1".equals(message.getStringAttribute("em_mine_type"))) {
//                        return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_RECORDS : MESSAGE_TYPE_SENT_RECORDS;
//                    }
