...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public void setListItemClickListener(EaseConversationListFragment.EaseConversationListItemClickListener listItemClickListener) {
        this.listItemClickListener = listItemClickListener;
    }

    private List<HxUserBean> userNameBeans = new ArrayList<>();

    public void setUserNameBeans(List<HxUserBean> userNameBeans) {
        this.userNameBeans = userNameBeans;
...
//                holder.es.collapseSmooth();
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            if (userNameBeans != null) {
                for (int i = 0; i < userNameBeans.size(); i++) {
                    if (username.equals(userNameBeans.get(i).getUserId())) {
                        name = userNameBeans.get(i).getNickName();
                        header = userNameBeans.get(i).getHeaderUrl();
                    }
                }
            }
            ...
            ImageUtils.getPic("" + header, holder.avatar, getContext(), R.drawable.ease_default_avatar);
        }
